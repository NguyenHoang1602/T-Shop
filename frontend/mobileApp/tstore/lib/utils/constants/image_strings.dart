class TImage {
   // -- App Logos
    static const String darkAppLogo = "assets/logos/t-store-splash-logo-black.png"; // Dark theme logo
    static const String lightAppLogo = "assets/logos/t-store-splash-logo-white.png"; // Light theme logo

    // -- Social Logos
    static const String google = "assets/logos/google-icon.png"; // Google logo
    static const String facebook = "assets/logos/facebook-icon.png"; // Facebook logo
